...
# User receipt
story += [header("Payment document", "Receipt R-2026-00842", "Paid"), P("Payment receipt", "TitleX"), P("Issued by VLOO AS on behalf of the host. Keep this document for your records.", "LeadX"), hero("Total paid", "NOK 2,500.00", "Paid 1 December 2026", "Stripe · Visa ending 4242"), P("Booking", "SectionX"), fields([("Workspace", "Star Design Agency · Studio 3"), ("Booking reference", "VLOO-FX-8K4Q2"), ("Booking type", "Flex booking"), ("Booking date", "1 December 2026 · 09:00-17:00")]), P("Price details", "SectionX"), data_table(["Description", "Qty", "Price excl. VAT", "VAT", "Total"], [["Studio 3 · full-day workspace", "1", "2,000.00", "25%", "2,500.00"]], [65*mm, 12*mm, 28*mm, 18*mm, 31*mm]), Spacer(1, 5), totals([("Subtotal", "NOK 2,000.00"), ("VAT (25%)", "NOK 500.00"), ("Total paid", "NOK 2,500.00")]), P("Supplier", "SectionX"), fields([("Host", "Nordic Workspaces AS<br/>Org. no. 123 456 789 MVA"), ("Payment facilitator", "VLOO AS · Org. no. 929 102 452 MVA<br/>Krokvolden 14, 1369 Stabekk")]), Spacer(1, 8), callout("VLOO AS processed this payment through Stripe on behalf of the host. The host is responsible for output VAT on the workspace rental."), PageBreak()]

# Host payout
story += [header("Host payment document", "Payout P-2026-00119", "Paid out"), P("Host payout statement", "TitleX"), P("A clear record of booking revenue, VLOO fees, and the amount transferred through Stripe.", "LeadX"), hero("Net payout", "NOK 2,125.00", "Transferred 2 December 2026", "Stripe payout po_1Qx84…"), P("Payout details", "SectionX"), fields([("Host", "Nordic Workspaces AS<br/>Org. no. 123 456 789 MVA"), ("Statement period", "1-1 December 2026"), ("Booking reference", "VLOO-FX-8K4Q2"), ("Workspace", "Star Design Agency · Studio 3")]), P("Payout calculation", "SectionX"), data_table(["Booking", "Gross incl. VAT", "VLOO fee incl. VAT", "Net to host"], [["1 Dec 2026 · VLOO-FX-8K4Q2<br/>Star Design Agency", "2,500.00", "375.00", "2,125.00"]], [70*mm, 28*mm, 29*mm, 27*mm]), Spacer(1, 5), totals([("Gross collected", "NOK 2,500.00"), ("VLOO fee deducted", "NOK 375.00"), ("Net payout", "NOK 2,125.00")]), P("Bookkeeping summary", "SectionX"), fields([("Rental revenue incl. VAT", "NOK 2,500.00"), ("Output VAT", "NOK 500.00"), ("Commission expense excl. VAT", "NOK 300.00"), ("Input VAT on commission", "NOK 75.00")]), Spacer(1, 7), callout("The VLOO commission was deducted before payout; no further payment is required. Stripe payout fees, if any, are set by Stripe and are outside VLOO's control."), PageBreak()]

# User booking confirmation / copy
story += [header("User booking confirmation / copy", "VLOO-FX-8K4Q2", "Confirmed", TEAL), P("Your booking confirmation", "TitleX"), P("This copy confirms the booking details for the user. It is not a payment receipt.", "LeadX"), booking_banner("Flex booking", "Studio 3 at Nordic Workspaces", "Krokvolden 14, 1369 Stabekk · Floor 2", "8K4Q2"), P("Date and access", "SectionX"), dates("Starts", "Tue 1 Dec · 09:00", "Ends", "Tue 1 Dec · 17:00"), P("Booking details", "SectionX"), fields([("Booked by", "Alex Morgan · alex@example.com"), ("Guests", "4 people"), ("Workspace", "Private studio · 4 desks"), ("Status", "Confirmed")]), P("What is included", "SectionX"), fields([("Amenities", "Wi-Fi · monitor · coffee · phone booth"), ("Access", "Unsure? Use the host chat to plan the details.")]), P("Price at booking", "SectionX"), data_table(["Description", "Subtotal", "VAT", "Total"], [["Studio 3 · full day", "2,000.00", "500.00", "NOK 2,500.00"]], [70*mm, 27*mm, 24*mm, 33*mm]), Spacer(1, 10), callout("<b>Need help?</b> Contact VLOO at +47 95 11 22 84 or VLOO support at andreas@vloo.co. Cancellation terms are the terms accepted when this booking was made."), PageBreak()]

# Host booking confirmation / copy
story += [header("Host booking confirmation / copy", "VLOO-FX-8K4Q2", "Confirmed", TEAL), P("Confirmed host booking", "TitleX"), P("The host's operational record of the confirmed booking and the guest details needed to deliver the stay.", "LeadX"), booking_banner("Flex booking", "Studio 3 at Nordic Workspaces", "Krokvolden 14, 1369 Stabekk · Floor 2", "8K4Q2"), P("Booking time", "SectionX"), dates("Guest arrives", "Tue 1 Dec · 09:00", "Guest leaves", "Tue 1 Dec · 17:00"), P("Guest and booking", "SectionX"), fields([("Primary guest", "Alex Morgan · alex@example.com<br/>+47 900 11 222"), ("Party size", "4 people"), ("Workspace", "Private studio · 4 desks"), ("Booking status", "Confirmed")]), P("Host preparation", "SectionX"), fields([("Access instruction", "Use the user chat to plan the details."), ("Included amenities", "Wi-Fi · monitor · coffee · phone booth"), ("Need help?", "Contact VLOO at +47 95 11 22 84 or VLOO support at andreas@vloo.co")]), P("Booking value", "SectionX"), data_table(["Gross incl. VAT", "VLOO fee incl. VAT", "Expected net payout", "Payout timing"], [["NOK 2,500.00", "NOK 375.00", "NOK 2,125.00", "Start of each month"]], [38*mm, 38*mm, 40*mm, 38*mm]), Spacer(1, 10), callout("<b>Host record:</b> this confirmation is not a payout statement or commission deduction statement. Final financial documents become available after payment and payout processing."), PageBreak()]

# VLOO commission deduction statement
story += [header("Accounting document", "Commission C-2026-00119", "Deducted"), P("VLOO commission deduction statement", "TitleX"), P("Accounting document for VLOO's 15% commission and VAT on the commission, deducted before the host payout.", "LeadX"), hero("Commission deducted", "NOK 375.00", "Booking VLOO-FX-8K4Q2", "Related payout P-2026-00119"), P("Statement details", "SectionX"), fields([("Issued by", "VLOO AS<br/>Org. no. 929 102 452 MVA"), ("Charged to", "Nordic Workspaces AS<br/>Org. no. 123 456 789 MVA"), ("Commission date", "2 December 2026"), ("Stripe payment reference", "pi_3Qx84…")]), P("Commission calculation", "SectionX"), data_table(["Description", "Commission base", "Rate", "Amount excl. VAT", "VAT"], [["VLOO commission · VLOO-FX-8K4Q2", "NOK 2,500.00", "15%", "NOK 300.00", "25%"]], [54*mm, 31*mm, 17*mm, 32*mm, 20*mm]), Spacer(1, 6), totals([("Commission excl. VAT", "NOK 300.00"), ("VAT on commission (25%)", "NOK 75.00"), ("Total commission deducted", "NOK 375.00")]), P("Bookkeeping summary", "SectionX"), fields([("Commission expense excl. VAT", "NOK 300.00"), ("Input VAT", "NOK 75.00"), ("Settlement method", "Deducted from host payout"), ("Amount payable", "NOK 0.00")]), Spacer(1, 9), callout("The 15% commission is calculated from the gross booking amount. VAT at 25% is applied to VLOO's commission. The total was already deducted from the related host payout; no further payment is required."), PageBreak()]

# Extended Stay user receipt - one receipt per completed monthly billing period
story += [header("Extended Stay payment document", "Receipt R-2027-00031", "Paid"), P("Extended Stay payment receipt", "TitleX"), P("Issued by VLOO AS on behalf of the host for one completed monthly billing period.", "LeadX"), hero("Total paid", "NOK 7,500.00", "Paid 1 January 2027", "Stripe · Visa ending 4242"), P("Booking", "SectionX"), fields([("Workspace", "Dedicated desk 14 · Nordic Workspaces"), ("Booking reference", "VLOO-ES-2N7P6"), ("Booking type", "Extended Stay"), ("Billing period", "1-31 January 2027")]), P("Price details", "SectionX"), data_table(["Description", "Qty", "Price excl. VAT", "VAT", "Total"], [["Dedicated desk · January 2027", "1 month", "6,000.00", "25%", "7,500.00"]], [65*mm, 18*mm, 27*mm, 18*mm, 26*mm]), Spacer(1, 5), totals([("Subtotal", "NOK 6,000.00"), ("VAT (25%)", "NOK 1,500.00"), ("Total paid", "NOK 7,500.00")]), P("Supplier", "SectionX"), fields([("Host", "Nordic Workspaces AS<br/>Org. no. 123 456 789 MVA"), ("Payment facilitator", "VLOO AS · Org. no. 929 102 452 MVA<br/>Krokvolden 14, 1369 Stabekk")]), Spacer(1, 8), callout("This receipt covers only the stated monthly billing period. The Extended Stay booking confirmation records the full stay and recurring billing arrangement."), PageBreak()]
...
story += [header("Extended Stay user confirmation / copy", "VLOO-ES-2N7P6", "Active", TEAL), P("Your Extended Stay confirmation", "TitleX"), P("This copy confirms the full stay and recurring monthly billing arrangement. It is not a payment receipt.", "LeadX"), booking_banner("Extended Stay", "Dedicated desk at Nordic Workspaces", "Krokvolden 14, 1369 Stabekk · Floor 2", "2N7P6"), P("Stay period", "SectionX"), dates("Move in", "1 Dec 2026", "Current end date", "28 Feb 2027"), P("Booking details", "SectionX"), fields([("Booked by", "Alex Morgan · alex@example.com"), ("Workspace", "Dedicated desk 14 · 1 person"), ("Billing frequency", "Monthly · charged on the 1st"), ("Status", "Active")]), P("Access", "SectionX"), fields([("Access details", "Unsure? Use the host chat to plan the details."), ("Included amenities", "Wi-Fi · monitor · coffee · phone booth")]), P("Billing schedule", "SectionX"), data_table(["Billing period", "Status", "Amount incl. VAT", "Receipt"], [["1-31 Dec 2026", "Paid", "NOK 7,500.00", "R-2026-00901"], ["1-31 Jan 2027", "Paid", "NOK 7,500.00", "R-2027-00031"], ["1-28 Feb 2027", "Scheduled", "NOK 7,500.00", "After payment"]], [36*mm, 24*mm, 38*mm, 56*mm]), Spacer(1, 8), callout("<b>Need help?</b> Contact VLOO at +47 95 11 22 84 or VLOO support at andreas@vloo.co. Cancellation terms are the terms accepted when this booking was made."), PageBreak()]

# Extended Stay host booking confirmation / copy
story += [header("Extended Stay host confirmation / copy", "VLOO-ES-2N7P6", "Active", TEAL), P("Confirmed Extended Stay booking", "TitleX"), P("The host's operational record of the active stay, recurring billing, guest, and expected monthly payout.", "LeadX"), booking_banner("Extended Stay", "Dedicated desk at Nordic Workspaces", "Krokvolden 14, 1369 Stabekk · Floor 2", "2N7P6"), P("Stay period", "SectionX"), dates("Guest moves in", "1 Dec 2026", "Current end date", "28 Feb 2027"), P("Guest and booking", "SectionX"), fields([("Primary guest", "Alex Morgan · alex@example.com<br/>+47 900 11 222"), ("Workspace", "Dedicated desk 14 · 1 person"), ("Billing frequency", "Monthly · charged on the 1st"), ("Booking status", "Active")]), P("Host preparation", "SectionX"), fields([("Access instruction", "Use the user chat to plan the details."), ("Included amenities", "Wi-Fi · monitor · coffee · phone booth"), ("Need help?", "Contact VLOO at +47 95 11 22 84 or VLOO support at andreas@vloo.co")]), P("Monthly booking value", "SectionX"), data_table(["Gross incl. VAT", "VLOO fee incl. VAT", "Expected net payout", "Payout timing"], [["NOK 7,500.00", "NOK 1,125.00", "NOK 6,375.00", "Start of each month"]], [38*mm, 38*mm, 40*mm, 38*mm]), Spacer(1, 10), callout("<b>Host record:</b> monthly payout and commission statements are generated for each successfully processed Extended Stay billing period."), PageBreak()]

# Extended Stay VLOO commission deduction statement
story += [header("Extended Stay accounting document", "Commission C-2027-00018", "Deducted"), P("VLOO commission deduction statement", "TitleX"), P("Monthly accounting document for VLOO's 15% Extended Stay commission and VAT on the commission.", "LeadX"), hero("Commission deducted", "NOK 1,125.00", "Booking VLOO-ES-2N7P6", "Billing period 1-31 Jan 2027"), P("Statement details", "SectionX"), fields([("Issued by", "VLOO AS<br/>Org. no. 929 102 452 MVA"), ("Charged to", "Nordic Workspaces AS<br/>Org. no. 123 456 789 MVA"), ("Commission date", "2 January 2027"), ("Related payout", "P-2027-00018")]), P("Commission calculation", "SectionX"), data_table(["Description", "Commission base", "Rate", "Amount excl. VAT", "VAT"], [["Extended Stay commission · Jan 2027", "NOK 7,500.00", "15%", "NOK 900.00", "25%"]], [54*mm, 31*mm, 17*mm, 32*mm, 20*mm]), Spacer(1, 6), totals([("Commission excl. VAT", "NOK 900.00"), ("VAT on commission (25%)", "NOK 225.00"), ("Total commission deducted", "NOK 1,125.00")]), P("Bookkeeping summary", "SectionX"), fields([("Commission expense excl. VAT", "NOK 900.00"), ("Input VAT", "NOK 225.00"), ("Settlement method", "Deducted from monthly host payout"), ("Amount payable", "NOK 0.00")]), Spacer(1, 9), callout("This statement covers one Extended Stay billing period. The 15% commission is calculated from the gross monthly booking amount, with 25% VAT applied to VLOO's commission.")]

doc.build(story)
from pypdf import PdfReader, PdfWriter
reader = PdfReader(OUT)
writer = PdfWriter()
for page_index in [0, 2, 3, 1, 4, 5, 7, 8, 6, 9]:
